...
\begin{figure}
    \centering
    \subfloat[$G_1$ query\label{fig:performance-g1}]{%
        \includegraphics[width=\squeryImageW\textwidth]{figures/g1_result.eps}
    }%
    \subfloat[$G_2$ query\label{fig:performance-g2}]{%
        \includegraphics[width=\squeryImageW\textwidth]{figures/g2_result.eps}
    }%
    \subfloat[$Geo$ query\label{fig:performance-geo}]{%
        \includegraphics[width=\squeryImageW\textwidth]{figures/geo_result.eps}
    }%
...
\begin{figure}
    \centering
    \subfloat[$\textit{reg}_1$ query\label{fig:performance-reg1}]{%
        \includegraphics[width=0.55\textwidth]{figures/reg1_rpq_result.eps}
    }%
    \hspace{-2em}
    \subfloat[$\textit{reg}_2$ query\label{fig:performance-reg2}]{%
        \includegraphics[width=0.55\textwidth]{figures/reg2_rpq_result.eps}
    }%
