...
\begin{itemize}
    \item For all graphs, queries and start vertices sets, described in section~\ref{section:dataset}, we measure evaluation time for both versions.
    \item Average time for each start vertices set size was calculated. Thus, for each graph, query, and start vertices set size we have an average time of respective query evaluation.
